...
CREATE INDEX idx_incident_embedding ON incident USING ivfflat (embedding vector_cosine_ops) WITH (lists = 100);
...
CREATE INDEX idx_lesson_embedding ON lesson USING ivfflat (embedding vector_cosine_ops) WITH (lists = 100);
