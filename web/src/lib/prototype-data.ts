...
export type Contribution = {
  domain: string;
  icon: string;
  status: "live" | "contributed" | "pending" | "dismissed";
  text: string;
};
...
export type Initiative = {
  col: "todo" | "progress" | "blocked" | "verify" | "closed";
  id: string;
  title: string;
  agent: string;
  target: "MES" | "SRM" | "Jira" | "ERP" | "CRM";
...
export type InboxIncident = {
  ...
  last: string;
  owner: string;
  status: "triage" | "reasoning" | "resolving" | "closed";
  conf: number;
  primary?: boolean;
};
...
export const PROTOTYPE_DATA = {
  ...
  incident: {
    ...
    hypotheses: [
      { id: "HYP-material", label: "MATERIAL", title: "Supplier batch SB-00007 ESR out of spec", conf: 82, evidence: 5, contradict: 0, primary: true, confirmed: true },
    ...
    contributions: [
      ...
      { domain: "Process Planning", icon: "flow", status: "pending", text: "" },
...
export const SIGNAL_TO_HYPOTHESIS: Record<string, string> = {
  "SIG-412": "HYP-material",
  "SIG-411": "HYP-material",
  "SIG-408": "HYP-material",
  "SIG-399": "HYP-process",
  "SIG-387": "HYP-process",
  "SIG-361": "HYP-material",
  "SIG-358": "HYP-operator",
  "SIG-340": "HYP-design",
};
